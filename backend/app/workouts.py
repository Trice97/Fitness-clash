...
from sqlalchemy.orm import relasionship
...
workout_exercices = relasionship(
    "WorkoutExercise",
...
class WorkoutExercise(Base):
    ...
    # clés étrangères
    workout_id = Column(Integer, ForeignKey("workouts.id", onedelete="CASCADE"), nullable=False)
    exercise_id = Column(Integer, ForeignKey("exercise.id", onedelete="CASCADE"), nullable=False)
