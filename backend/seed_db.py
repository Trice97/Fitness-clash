"""
Script pour initialiser la base de données avec les exercices de référence
45 exercices bodyweight avec progression logique par difficulté
"""
...
def seed_exercises():
    """Remplir la table exercises avec tous les exercices"""
    
    db = SessionLocal()
    
    try:
        print("🌱 Début du seeding des exercices...")
